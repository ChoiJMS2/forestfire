...
from data.load_data import get_dataframe_from_bigquery
...
def run_twoMeans():
    ...
    with tab2:
        # 데이터 가져오기
        analysis_data = get_dataframe_from_bigquery("Analysis_Data", "Analysis_Data").sort_values(["fire_occur"])
        selected_data = analysis_data[['avgTa', 'sumRn', 'avgWs', 'avgRhm', 'effRhm', 'Rntf', 'noRn', 'fire_occur']]
        # 컬럼 선택
